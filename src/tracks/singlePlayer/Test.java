...
public class Test {
    ...
    public static void main(String[] args) {
		...
		String myLRTAStarKController = "tracks.singlePlayer.evaluacion.src_PEDREGOSA_GARCIA_JOSE.AgenteLRTAStarK";
		...
		String recordActionsFile =  "logs/actions_" + games[gameIdx] + "_lvl"
						 + levelIdx + "_" + seed + ".txt";
